...
import com.example.priya.E_ShopWithvoiceAssistance.PaymentActivity;
...
public class BkashService extends Service  implements ChildEventListener{
    ...
    private void showNotification(String key, Request request) {
        ...
        builder.setAutoCancel(true)
                ...
                .setContentText("Order # "+key+" Your Transaction Code  "+ Common.convertCodeToTransaction(request.getStatus()))
