...
public class SpeechHome extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent cartIntent = new Intent(SpeechHome.this,SpeechCart.class);
        ...
        navigationView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String toSpeak = "You are in home page..there are product catagory...in the left upper corner there is a button if you click on this you will find menu option order option cart option and log out option.......................And right bottom corner there is a button for cart list";
    ...
    private void loadMneu() {
        adapter  = new FirebaseRecyclerAdapter<Blog, MainViewHolder>(Blog.class,R.layout.menu_item,MainViewHolder.class,catagory) {
            @Override
            protected void populateViewHolder(final MainViewHolder viewHolder, Blog model, int position) {
                ...
                viewHolder.setItemClickListener(new ItemClickListener() {
                    ...
                    public void onClick(View view, int position, boolean isOnClick) {
                        String toSpeak = clickitem.getName()+"";
                        t1.speak(toSpeak, TextToSpeech.QUEUE_FLUSH, null);
                        t1.playSilentUtterance(1000, TextToSpeech.QUEUE_ADD,null);
                        Toast.makeText(SpeechHome.this,""+clickitem.getName(),Toast.LENGTH_SHORT).show();
                        viewHolder.setItemClickListener(new ItemClickListener() {
                            @Override
                            public void onClick(View view, int position, boolean isOnClick) {
                                Intent foodList = new Intent(SpeechHome.this,SpeechProductList.class);
                                Toast.makeText(SpeechHome.this,""+clickitem.getName(),Toast.LENGTH_SHORT).show();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        // automatically handle clicks on the SpeechHome/Up button, so long
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_menu) {
          ...
          //  Log.d("Accc","pppppp")
            Intent orderIntent = new Intent(SpeechHome.this,SpeechOrderStatus.class);
            startActivity(orderIntent);


        } else if (id == R.id.nav_log_out) {

            Intent signIn = new Intent(SpeechHome.this,LoginActivity.class);
